...
public class Runner {
    ...
    public static void main(String[] args) throws JsonProcessingException {
        ...
        System.out.println("Serialization from Gson Library");
        ...
        System.out.println("Deserialization from Gson Library");
        System.out.println(user2);

        //Serialization using Jackson library
        ObjectMapper mapper = new ObjectMapper();
        String user3 = mapper.writeValueAsString(user);
        System.out.println("Serialization from Jackson Library");
        ...
        System.out.println("Deserialization from Jackson Library");
